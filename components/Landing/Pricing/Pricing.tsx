      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col w-full mb-20 text-center">
          ...
          <p className="mx-auto text-base leading-relaxed text-gray-500 lg:w-2/3">
            Automate one sphere of your life with HomeLab! Reserve your package
            today.
          </p>
        </div>
          ...
          <div className="w-full p-4 xl:w-1/3 md:w-1/2">
            <div className="relative flex flex-col h-full p-6 overflow-hidden border-2 border-gray-300 rounded-lg">
              ...
              <p className="mt-3 text-xs text-gray-500">
                <span className="font-semibold">NOTE: </span> With this package,
                as well as with others, it is possible to install countless
                bulbs, the only condition being that they are smart.
              </p>
            </div>
          </div>
          <div className="w-full p-4 xl:w-1/3 md:w-1/2">
